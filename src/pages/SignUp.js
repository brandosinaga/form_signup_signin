...
import {useState} from "react";
 ...
 export default function SignUp({number, handleAddNumber, dispatch}){
    ...
    const onSubmit = (items) => dispatch({type : "add_newToko", newToko : {id_user, nama_user, city, email, password, products : [...items]}})
